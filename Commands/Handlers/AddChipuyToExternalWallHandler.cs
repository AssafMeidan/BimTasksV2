...
{
    /// <summary>
    /// Adds cladding (chipuy) walls to the exterior side only of selected walls.
    /// Validates the selection, then delegates to CladdingWallCreator.
    /// </summary>
    public class AddChipuyToExternalWallHandler : ICommandHandler
    {
        public void Execute(UIApplication uiApp)
        {
            ...
            try
            {
                ...
                CladdingWallCreator.AddCladdingToExternalSide(doc, selectedWalls);
            }
            ...
            {
                Log.Error(ex, "AddChipuyToExternalWallHandler failed");
